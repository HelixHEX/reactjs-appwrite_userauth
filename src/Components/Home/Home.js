...
// require('https://fonts.googleapis.com/css?family=Poppins:200,300,400,600,700,800')
    ...
    return (
      <>
        <div className="logout-btn">
          <button type="button" onClick={this.signOutUser} class="btn btn-dark">Logout</button>
        </div>
